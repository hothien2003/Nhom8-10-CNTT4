	...
	public static void main(String[] args)
	{
		...
		do
		{
			...
			switch (chon)
			{
				...
				case 3:
				{
					System.out.print("So dien su dung = "); int SoDien = data.nextInt();
					TienDien(SoDien);
				} break;
				case 4:
				{
					System.out.print("So nguyen n = "); int n = data.nextInt();
					SoCP(n);
				} break;
				case 5:
				{
					System.out.print("So Diem Trung Binh = "); double Dtb = data.nextDouble();
					Xeploai(Dtb);
				} break;
				case 6:
				{
					int so;
					System.out.print("So co 3 chu so = "); so = data.nextInt();
					while ((so<100) || (so>999))
					{
						System.out.print("So co 3 chu so = "); so = data.nextInt();
						if ((so>=100) && (so<=999))
				...
				case 7:
				{
					System.out.print("So n = "); int n = data.nextInt();
					Giaithuawhile(n);
				} break;
				case 8:
				{
				...
				case 9:
				{
					System.out.print("So mang n = "); int n = data.nextInt();
					int[] a = new int[n];
					Random_Array(a,n);
					Out_Array(a,n);
					System.out.print("\n");
					System.out.print("Vi tri can xoa: "); int k = data.nextInt();
					XoaX(a,n,k);
					Out_Array(a,n);
				} break;
				case 10:
